...
description: "We combine some encryption methods to create the token"
---

We have our own algorithm for making requests to hit our endpoint. This algorithm referred to the [security pre-requirement](/prerequirement) which requires to generate key for each transaction.
